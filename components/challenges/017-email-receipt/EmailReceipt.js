...
const StyledEmailReceipt = styled.div`
  ...
  .design-circle-fill {
    ...
    bottom: ${theme.size.m};
    border-radius: 1000em;
    transform: translateY(${theme.em(110)});
  }
`;
...
const EmailReceipt = () => {
  return (
    <StyledEmailReceipt>
      ...
      <div className="container">
        <header className="header">
          ...
          <div className="header__detail-box">
            ...
            <div className="text-box">
              <span className="text text--uppercase">Order Number:&nbsp;</span>
      ...
      <div className="design-back-plate" />
      <div className="design-circle-outline" />
      <div className="design-circle-fill" />
    </StyledEmailReceipt>
  );
};
