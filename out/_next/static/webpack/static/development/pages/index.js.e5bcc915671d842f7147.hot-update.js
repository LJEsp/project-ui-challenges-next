...
})(["h1{font-size:3em;margin-bottom:1em;}nav div{width:100%;max-width:50em;display:grid;grid-template-columns:4em 1fr auto;grid-column-gap:1em;&:not(:last-child){margin-bottom:1em;}@media (max-width:37.4375em){grid-template-rows:auto auto;grid-template-columns:1fr auto;}}.day{}.date{@media (max-width:37.4375em){grid-column:2 / -1;grid-row:1 / 2;}}a{color:#2196f3;&:link{color:#2196f3;}&:hover{color:#1565c0;}&:active{}&:visited{color:#9c27b0;}}"]);
...
//# sourceMappingURL=index.js.e5bcc915671d842f7147.hot-update.js.map