...
})(["h1{font-size:3em;margin-bottom:1em;}nav div{width:100%;max-width:50em;display:grid;grid-template-columns:4em 1fr auto;grid-column-gap:1em;&:not(:last-child){margin-bottom:1em;}@media (max-width:37.4375em){grid-template-columns:1fr auto;}}a{color:#2196f3;&:link{color:#2196f3;}&:hover{color:#1565c0;}&:active{}&:visited{color:#9c27b0;}}"]);
...
//# sourceMappingURL=index.js.6fdfba51af61aabc02e4.hot-update.js.map