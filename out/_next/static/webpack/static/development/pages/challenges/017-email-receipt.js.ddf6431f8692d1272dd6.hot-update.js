...
})(["width:", ";position:relative;.container{width:", ";transform:skewY(12deg);transform-origin:top left;padding-top:", ";padding-right:", ";padding-left:", ";background:linear-gradient( 180deg,#f5f5f5 0%,rgba(245,245,245,0.9) 100% );box-shadow:4px 8px 24px rgba(0,0,0,0.2);> *{transform:skewY(-12deg);transform-origin:top left;}}.header{display:flex;margin-bottom:", ";&__logo{margin-right:", ";}&__detail-box{align-self:flex-end;}}.heading{height:", ";display:flex;justify-content:center;align-items:flex-end;margin-bottom:", ";&__text{font-weight:700;text-align:center;letter-spacing:0.08em;text-transform:uppercase;}}.text-box{height:", ";display:flex;align-items:flex-end;}.text{&--uppercase{text-transform:uppercase;}&--data{letter-spacing:0.08em;}}.logo{fill:", ";width:", ";height:", ";&__svg{fill:inherit;}}.product-box{display:grid;grid-template-columns:auto 4fr 1fr 1fr;grid-column-gap:", ";justify-items:start;}.product-box:not(:last-child){border:1px solid magenta;}.product{width:", ";height:", ";border:", " solid ", ";border-radius:1000em;overflow:hidden;&__image{width:100%;height:100%;object-fit:cover;}}.design-outline{position:absolute;top:", ";right:0;bottom:calc(", " * -1);left:", ";border:", " solid ", ";transform:skewY(12deg);transform-origin:top left;}.design-back-plate{position:absolute;top:", ";bottom:calc(", " * -1);left:calc(50% - 100% / 1.618 / 2);width:calc(100% / 1.618);background-color:", ";border-radius:", ";transform:scaleX(-1) skewY(12deg);z-index:-1;}.design-circle-outline{width:", ";height:", ";border:", " solid ", ";border-radius:1000em;position:absolute;top:", ";right:", ";}.design-circle-fill{background-color:", ";width:", ";height:", ";position:absolute;left:", ";bottom:", ";border-radius:1000em;transform:translateY(", ");}"], theme.em(464), theme.em(448), theme.size.xl, theme.em(24), theme.em(40), theme.size.m, theme.size.l, theme.size.l, theme.size.m, theme.size.l, theme.color.primary, theme.em(96), theme.em(96), theme.size.m, theme.size.xl, theme.size.xl, theme.em(1), theme.color.white, theme.size.m, theme.size.m, theme.size.m, theme.em(2), theme.color.white, theme.size.l, theme.size.xl, theme.color.dark, theme.size.s, theme.size.l, theme.size.l, theme.size.xs, theme.color.primary, theme.em(28), theme.em(40), theme.color.primary, theme.size.m, theme.size.m, theme.em(216), theme.size.m, theme.em(110));
...
//# sourceMappingURL=017-email-receipt.js.ddf6431f8692d1272dd6.hot-update.js.map