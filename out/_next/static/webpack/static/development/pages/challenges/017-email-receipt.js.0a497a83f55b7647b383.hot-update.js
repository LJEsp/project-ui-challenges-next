...
var EmailReceipt = function EmailReceipt() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledEmailReceipt, {
    ...
    delay: 700,
    from: {
      transform: "scale(0) translateY(".concat(theme.em(110), ")")
    },
    to: {
      transform: "scale(1) translateY(".concat(theme.em(110), ")")
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 446
...
//# sourceMappingURL=017-email-receipt.js.0a497a83f55b7647b383.hot-update.js.map