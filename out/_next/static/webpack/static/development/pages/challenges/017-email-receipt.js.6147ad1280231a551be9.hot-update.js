...
})(["margin-bottom:", ";max-width:", ";position:relative;.container{transform:skewY(12deg);transform-origin:top left;padding-top:", ";padding-right:", ";padding-left:", ";background:linear-gradient( 180deg,#f5f5f5 0%,rgba(245,245,245,0.9) 100% );box-shadow:0.3em 0.6em 3em rgba(0,0,0,0.2);@media (max-width:", "){padding-left:", ";padding-top:", ";padding-bottom:", ";}> *{transform:skewY(-12deg);transform-origin:top left;}}.header{display:flex;margin-bottom:", ";@media (max-width:", "){flex-flow:column;}&__logo{margin-right:", ";@media (max-width:", "){align-self:center;margin-right:0;}}&__detail-box{align-self:flex-end;@media (max-width:", "){align-self:center;display:flex;flex-flow:column;align-items:center;}}}.heading{height:", ";display:flex;justify-content:center;align-items:flex-end;margin-bottom:", ";&__text{font-weight:700;text-align:center;letter-spacing:0.08em;text-transform:uppercase;}}.text-box{padding-top:", ";display:flex;flex-flow:row wrap;align-items:flex-end;&--center{justify-content:center;}&--right{justify-content:flex-end;text-align:center;@media (max-width:", "){justify-content:center;}}}.text{&--uppercase{text-transform:uppercase;}&--data{letter-spacing:0.08em;}&--bold{font-weight:700;}}.logo{fill:", ";width:", ";height:", ";&__svg{fill:inherit;}}.product-box{display:grid;grid-template-columns:auto 4fr 1fr 1fr;grid-column-gap:", ";justify-items:start;margin-bottom:", ";@media (max-width:", "){grid-template-columns:4fr 1fr 1fr;grid-column-gap:", ";grid-row-gap:", ";}}.product{width:", ";height:", ";border:", " solid ", ";border-radius:1000em;overflow:hidden;@media (max-width:", "){grid-column:1 / -1;justify-self:center;}&__image{width:100%;height:100%;object-fit:cover;}}.total-box{display:flex;justify-content:flex-end;margin-bottom:", ";@media (max-width:", "){justify-content:center;}div:first-child{margin-right:", ";}}.divider{width:100%;height:", ";background-color:", ";}.button-box{display:flex;justify-content:flex-end;@media (max-width:", "){justify-content:center;}}.button{margin-top:", ";background-color:", ";box-shadow:0em 0.25em 0.25em rgba(0,0,0,0.25);border-radius:1000em;color:", ";padding:", " ", ";text-transform:uppercase;font-weight:700;letter-spacing:0.04em;transition-duration:0.15s;&:hover{background-color:", ";}&:active{}}.design-outline{position:absolute;top:", ";right:calc(", " * -1);bottom:calc(", " * -1);left:", ";border:", " solid ", ";transform:skewY(12deg);transform-origin:top left;pointer-events:none;@media (max-width:", "){top:", ";left:", ";right:", ";}}.design-back-plate{position:absolute;top:", ";bottom:calc(", " * -1);left:calc(50% - 100% / 1.618 / 2);width:calc(100% / 1.618);background-color:", ";border-radius:", ";transform:scaleX(-1) skewY(12deg);z-index:-1;}.design-circle-outline{width:", ";height:", ";border:", " solid ", ";border-radius:1000em;position:absolute;top:", ";right:", ";}.design-circle-fill{background-color:", ";width:", ";height:", ";position:absolute;left:calc(50% - ", " / 2);bottom:", ";border-radius:1000em;margin-bottom:calc(", " * -1);}"], theme.em(110), theme.em(464), theme.size.xl, theme.em(24), theme.em(40), theme.breakpoint.first, theme.em(24), theme.em(72), theme.size.m, theme.size.m, theme.breakpoint.first, theme.size.l, theme.breakpoint.first, theme.breakpoint.first, theme.size.l, theme.size.m, theme.size.m, theme.breakpoint.first, theme.color.primary, theme.em(96), theme.em(96), theme.size.m, theme.size.m, theme.breakpoint.first, theme.size.s, theme.size.m, theme.size.xl, theme.size.xl, theme.em(1), theme.color.white, theme.breakpoint.first, theme.size.m, theme.breakpoint.first, theme.size.m, theme.em(1), theme.color.dark, theme.breakpoint.first, theme.size.m, theme.color.primary, theme.color.white, theme.size.s, theme.size.m, theme.color.dark, theme.size.m, theme.size.m, theme.size.m, theme.size.m, theme.em(2), theme.color.white, theme.breakpoint.first, theme.size.m, theme.size.s, theme.size.s, theme.size.l, theme.size.xl, theme.color.dark, theme.size.s, theme.size.l, theme.size.l, theme.size.xs, theme.color.primary, theme.em(28), theme.em(40), theme.color.primary, theme.size.m, theme.size.m, theme.size.m, theme.size.m, theme.em(110));
...
//# sourceMappingURL=017-email-receipt.js.6147ad1280231a551be9.hot-update.js.map